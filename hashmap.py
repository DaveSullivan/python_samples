""" Code that shows an object oriented implementation of hash map type functions from the hashmap.py module

Code adapted by Dave Sullivan, originally taken from
